...
class MyApplication : Application() {
    ...
    companion object {
        ...
        fun loadPdfSize(pdfUrl: String, pdfTitle: String, sizeTv: TextView) {
            ...
            ref.metadata.addOnSuccessListener { storageMetaDate ->

                Log.d(TAG, "loadPdfSize: got metaData")
                val bytes = storageMetaDate.sizeBytes.toDouble()
                ...
                .addOnFailureListener { e ->
                    Log.d(TAG, "loadPdfSize: Failed to get metaData dur to ${e.message}")
                }
              ...
              ref.getBytes(Constants.MAX_BYTES_PDF)
                  .addOnSuccessListener { bytes ->
                      ...
                      pdfView.fromBytes(bytes)
                          ...
                          .onLoad { nbPage ->
                              Log.d(TAG, "loadPdfFromUrlSinglePage: Pages: $nbPage")
                              progressBar.visibility = View.INVISIBLE
        ...
        fun deleteBook(context: Context, bookId: String, bookUrl: String, bookTitle: String) {
            ...
            progressBar.setMessage("Deleting $bookTitle")
        ...
        fun incrementBookViewCount(courseName: String, courseId: String) {

            val ref = FirebaseDatabase.getInstance().getReference("Pdf")
                .child(courseName).child(courseId)
                .addListenerForSingleValueEvent(object : ValueEventListener {
                    override fun onDataChange(snapshot: DataSnapshot) {
                        ...
                        val refDB = FirebaseDatabase.getInstance().getReference("Pdf")
                        refDB.child(courseName).child(courseId).updateChildren(hashMap)

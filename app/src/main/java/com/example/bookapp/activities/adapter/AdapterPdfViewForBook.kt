...
class AdapterPdfViewForBook : RecyclerView.Adapter<AdapterPdfViewForBook.ViewHolder>{

    private lateinit var binding: ListPdfViewBinding
    private val context: Context
    var modelPdfList: ArrayList<ModelPdfViewForBook>

    constructor(context: Context, modelPdf: ArrayList<ModelPdfViewForBook>) : super() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AdapterPdfViewForBook.ViewHolder {
        binding = ListPdfViewBinding.inflate(LayoutInflater.from(context),parent,false)
        return ViewHolder(binding.root)
    }

    override fun onBindViewHolder(holder: AdapterPdfViewForBook.ViewHolder, position: Int) {
